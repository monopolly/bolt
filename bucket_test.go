...
import (
	...
	"github.com/monopolly/bolt"
)

/*
func TestBucket_Counter(t *testing.T) {
	file.Delete("test.db")
	db, _ := bolt.Open("test.db", os.ModePerm, nil)
	...
	db.Update(func(tx *bolt.Tx) error {
		...
		fmt.Println("count 0", b.Count())
		b.Auto([]byte("foo1"))
		//b.Inc()
		fmt.Println("count 1", b.Count())
		b.Auto([]byte("foo2"))
		//b.Inc()
		fmt.Println("count 2", b.Count())
		return nil
	})
	...
	db.Update(func(tx *bolt.Tx) error {
		...
		b.Auto([]byte("foo1"))
		//b.Inc()
		fmt.Println("count 3", b.Count())
		b.Auto([]byte("foo2"))
		//b.Inc()
		fmt.Println("count 4", b.Count())
		return nil
	})
